...
export default function SearchableSelect({ 
  ...
  inputClassName = "w-full bg-[#0B1437] border border-white/10 rounded-xl pl-4 pr-10 py-3 text-sm text-white focus:outline-none focus:border-blue-500 transition-all placeholder:text-[#A3AED0]/50"
}) {
